    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          // titulo
          Text(
            '¿Como se cálcula el vólumen de un Sólido de Revolución?',
          ...
          SizedBox(height: 20,),
          Text(
            'En general, para el cálculo del vólumen de un sólido de revolución se puede recurrir al cálculo integral. Una forma, llamada el método de discos, consiste en dividir la figura en infinitos discos o porciones circulares, haciendo una sumatoria de sus vólumenes.',
            textAlign: TextAlign.justify,
            style: TextStyle(
