...
class home_sumas extends StatelessWidget {
  const home_sumas({Key? key}) : super(key: key);
      ...
      children: <Widget>[
        Stack(
          ...
          MaterialButton(
            ...
            height: 114,
            onPressed: () {
              Navigator.pushNamed(context, "explSumasRiemann");
            },
          ),
      ...
      children: <Widget>[
        Stack(
          ...
          MaterialButton(
            ...
            height: 114,
            onPressed: () {
              Navigator.pushNamed(context, "ejemSumasRiemann");
            },
          ),
        ...
        Stack(
          ...
          children: <Widget>[
            ...
            MaterialButton(
              ...
              height: 114,
              onPressed: () {
                Navigator.pushNamed(context, "ejSumasRiemann");
              },
            ),
          ],
        ),
